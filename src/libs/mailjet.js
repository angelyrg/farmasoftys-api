...
async function sendWelcomeEmail({ to, name, solicitud }) {
    try {
        console.log('Usando FROM:', process.env.MAILJET_FROM_EMAIL)
                ...
                Messages: [
                    {
                        ...
                        Subject: 'Solicitud de tienda registrada - Acción requerida en FarmaSoftys',
                        HTMLPart: `
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
                            <tr>
                                <td align="center" style="padding-bottom: 20px;">
                                    <img src="https://res.cloudinary.com/dlnx6im7h/image/upload/v1756937777/softys/hvqicbnbnzbntdec6tmz.webp" alt="FarmaSoftys" width="150" style="display: block;" />
                                </td>
                            </tr>
                            <tr>
